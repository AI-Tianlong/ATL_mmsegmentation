...
model=dict(
        ...
        # backbone = [{**backbone_config, 'in_channels': 3},
        #             {**backbone_config, 'in_channels': 4},,
        #             {**backbone_config, 'in_channels': 10}]
        backbone_MSI_3chan={**backbone_config, 'in_channels': 3},
        backbone_MSI_4chan={**backbone_config, 'in_channels': 4},
        backbone_MSI_10chan={**backbone_config, 'in_channels': 10},
